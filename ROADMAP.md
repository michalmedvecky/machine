...
milestones](https://github.com/michalmedvecky/machine/milestones).)
...
An [Open-Source Planning Process](https://github.com/michalmedvecky/machine/wiki/Open-Source-Planning-Process) is used to define the Roadmap. [Project Pages](https://github.com/michalmedvecky/machine/wiki) define the goals for each Milestone and identify current progress.
